...
user1 = User.objects.create_user(username='user11111')
user2 = User.objects.create_user(username='user2111')
...
# Создание категорий
category1 = Category.objects.create(name='Sport1')
category2 = Category.objects.create(name='Politics1')
category3 = Category.objects.create(name='Education1')
category4 = Category.objects.create(name='Technology1')
